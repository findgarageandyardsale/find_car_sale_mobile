...
import 'package:findcarsale/services/price_input_formatter.dart';
...
class _AddPostSaleScreenState extends ConsumerState<AddEditPostSaleScreen> {
  ...
  void initState() {
    ...
    priceController.text = widget.garageayard?.price?.toString() ?? '';
                    ...
                    AuthField(
                      ...
                      onChanged: (value) {
                        Future.microtask(() {
                          ...
                          ref
                              .read(addNotifierProvider.notifier)
                              .setPrice(double.tryParse(cleanValue) ?? 0);
                        });
                      },
