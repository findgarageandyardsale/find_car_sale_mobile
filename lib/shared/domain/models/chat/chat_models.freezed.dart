...
class _$ChatMessageImpl with DiagnosticableTreeMixin implements _ChatMessage {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ChatMessage(id: $id, senderId: $senderId, receiverId: $receiverId, garageYardId: $garageYardId, message: $message, messageType: $messageType, createdAt: $createdAt, updatedAt: $updatedAt, isRead: $isRead, isDeleted: $isDeleted, imageUrl: $imageUrl, fileUrl: $fileUrl, replyTo: $replyTo)';
  }
...
class _$ChatRoomImpl with DiagnosticableTreeMixin implements _ChatRoom {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ChatRoom(id: $id, participants: $participants, garageYardId: $garageYardId, garageYardTitle: $garageYardTitle, chatInitiatedByUsername: $chatInitiatedByUsername, lastMessage: $lastMessage, createdAt: $createdAt, updatedAt: $updatedAt, isActive: $isActive, unreadCount: $unreadCount, lastReadBy: $lastReadBy)';
  }
